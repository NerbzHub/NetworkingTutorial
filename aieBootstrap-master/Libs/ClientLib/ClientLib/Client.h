...
public:
	...
	void handleNetworkConnection(RakNet::RakPeerInterface* pPeerInterface);
	void initialiseClientConnection(RakNet::RakPeerInterface* pPeerInterface);
	...
	void sendClientGameObject(RakNet::RakPeerInterface* pPeerInterface, int myClientID, GameObject* myGameObject);

	void onReceivedClientDataPacket(RakNet::Packet * packet, std::unordered_map<int, GameObject> otherClientGameObjects);
